...
namespace Cratesmith.Collections.Basic
{
        public class PreallocLinkList<T> : ICollection<T>
    {
	    private object m_lock = new Object();
	    private Node m_freeHead = null;
        ...
        private void CreateFreeNodes(int numNodes)
        {
	        lock (m_lock)
	        {
        ...
        public void RemoveNode(Node node)
        {
	        ...
	        lock (m_lock)
	        {
		        var prevFreeHead = m_freeHead;
		        m_freeHead = node;
		        if (prevFreeHead != null)
		        {
			        m_freeHead.m_next = prevFreeHead;
			        m_freeHead.m_prev = null;
		        }
	        }
